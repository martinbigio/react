...
export type Fiber = [
  ...
  Flags, // flags
  Flags, // subtreeFlags
  Array<Fiber> | null, // deletions
  Lanes, // lanes
  Lanes, // childLanes
  Fiber | null, // alternate
  number | null, // actualDuration
  number | null, // actualStartTime
  number | null, // selfBaseDuration
  number | null, // treeBaseDuration
  ReactDebugInfo | null, // _debugInfo
  ReactComponentInfo | Fiber | null, // _debugOwner
  boolean, // _debugIsCurrentlyTiming
  boolean, // _debugNeedsRemount
  Array<HookType> | null, // _debugHookTypes
];
